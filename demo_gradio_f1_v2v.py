...
@torch.no_grad()
def worker(input_image, input_video, prompt, n_prompt, seed, total_second_length, latent_window_size, steps, cfg, gs, rs, gpu_memory_preservation, use_teacache, mp4_crf, denoise_strength):
    ...
    try:
        ...
        for section_index in range(total_latent_sections):
            ...
            latents = video_latents[:, :, latent_window_size*section_index:latent_window_size*(section_index+1), :, :]
...
def process(input_image, input_video, prompt, n_prompt, seed, total_second_length, latent_window_size, steps, cfg, gs, rs, gpu_memory_preservation, use_teacache, mp4_crf, denoise_strength):
    global stream
    ...
    async_run(worker, input_image, input_video, prompt, n_prompt, seed, total_second_length, latent_window_size, steps, cfg, gs, rs, gpu_memory_preservation, use_teacache, mp4_crf, denoise_strength)
...
with block:
    ...
    ips = [input_image, input_video, prompt, n_prompt, seed, total_second_length, latent_window_size, steps, cfg, gs, rs, gpu_memory_preservation, use_teacache, mp4_crf, denoise_strength]
